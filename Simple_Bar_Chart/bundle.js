...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chart_data = __webpack_require__(1);
	
	var mydata = _chart_data.GDPdata["data"].map(function (element) {
	  return element[1];
	});
	...
	d3.select("svg").selectAll(".bar").data(mydata).enter().append("rect").attr("class", "bar").attr("x", function (d, i) {
	  return x(i);
	}).attr("y", function (d, i) {
	  return 430 - y(d);
